                    ...
                    child: ListView(
                      children: [
                        ...
                        SwitchListTile(
                            ...
                            onChanged: (bool value) {
                              setState(() {
                                this.filterOptions.includeBakeryProducts =
                                    value;
                              });
                            }),
                        SwitchListTile(
...
class FilterOptions {
  ...
  List<String> getIncludedList() {
    ...
    if (includeVegetables) included.add("vegetables");
    if (includeMeat) included.add("meat");
    if (includeFruits) included.add("fruits");
    if (includeMilkProducts) included.add("milk-products");
    if (includeBakeryProducts) included.add("bakery-products");
    if (includeExotic) included.add("exotic");
    if (includeOther) included.add("other");
    //print(included);
    return included;
  }
}
